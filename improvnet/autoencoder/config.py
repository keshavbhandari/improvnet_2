...
ATTN_DROPOUT   = 0.05
FFN_DROPOUT    = 0.15
LATENT_NOISE   = 0.05  # 0.02
CONSISTENCY_WEIGHT = 0.25   # Weight for the consistency loss (MSE between noisy and clean latents)
...
VAL_EVERY      = 20000   # Run validation every N steps
SAVE_DIR       = f"/gpfs/scratch/acw769/improvnet/artifacts/autoencoder_v2_{PATCH_SIZE}patch_{LATENT_DIM}latent_{LATENT_NOISE}noise"
VAL_LOG_FILE   = f"val_metrics_autoencoder_v2_{PATCH_SIZE}patch_{LATENT_DIM}latent_{LATENT_NOISE}noise.txt"
RUN_NAME       = f"autoencoder_v2_{PATCH_SIZE}patch_{LATENT_DIM}latent_{LATENT_NOISE}noise"
